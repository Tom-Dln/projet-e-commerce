...
function listProductsGeneration() {
    ...
    if ($('title:first-of-type').text() == 'iCE - Reseau') {
        $('#products-show').append(`<div id="${product1.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product1.img1}" class="product-photo img-fluid" alt="${product1.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product1.name}</a></h5><p class="color-subtext">${product1.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product1.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product1.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
        if (product1.stock > 0) {
        ...
        $('#products-show').append(`<div id="${product2.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product2.img1}" class="product-photo img-fluid" alt="${product2.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product2.name}</a></h5><p class="color-subtext">${product2.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product2.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product2.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
        if (product2.stock > 0) {
        ...
        listProductsBackground();
        $('#products-show').append(`<div id="${product3.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product3.img1}" class="product-photo img-fluid" alt="${product3.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product3.name}</a></h5><p class="color-subtext">${product3.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product3.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product3.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
        if (product3.stock > 0) {
        ...
        listProductsBackground();
        $('#products-show').append(`<div id="${product4.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product4.img1}" class="product-photo img-fluid" alt="${product4.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product4.name}</a></h5><p class="color-subtext">${product4.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product4.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product4.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
        if (product4.stock > 0) {
        ...
        listProductsBackground();
        $('#products-show').append(`<div id="${product5.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product5.img1}" class="product-photo img-fluid" alt="${product5.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product5.name}</a></h5><p class="color-subtext">${product5.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product5.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product5.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
        if (product5.stock > 0) {
        ...
        listProductsBackground();
        $('#products-show').append(`<div id="${product6.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product6.img1}" class="product-photo img-fluid" alt="${product6.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product6.name}</a></h5><p class="color-subtext">${product6.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product6.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product6.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
        if (product6.stock > 0) {
        ...
        listProductsBackground();
        $('#products-show').append(`<div id="${product7.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product7.img1}" class="product-photo img-fluid" alt="${product7.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product7.name}</a></h5><p class="color-subtext">${product7.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product7.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product7.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
        if (product7.stock > 0) {
        ...
        listProductsBackground();
        $('#products-show').append(`<div id="${product8.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product8.img1}" class="product-photo img-fluid" alt="${product8.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product8.name}</a></h5><p class="color-subtext">${product8.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product8.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product8.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
        if (product8.stock > 0) {
        ...
        listProductsBackground();
        $('#products-show').append(`<div id="${product9.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product9.img1}" class="product-photo img-fluid" alt="${product9.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product9.name}</a></h5><p class="color-subtext">${product9.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product9.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product9.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
        if (product9.stock > 0) {
        ...
        listProductsBackground();
        $('#products-show').append(`<div id="${product10.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product10.img1}" class="product-photo img-fluid" alt="${product10.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product10.name}</a></h5><p class="color-subtext">${product10.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product10.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product10.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
        ...
        listProductsBackground();
        $('#products-show').append(`<div id="${product11.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product11.img1}" class="product-photo img-fluid" alt="${product11.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product11.name}</a></h5><p class="color-subtext">${product11.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product11.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product11.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
    ...
    if ($('title:first-of-type').text() == 'iCE - Usb') {
        $('#products-show').append(`<div id="${product13.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product13.img1}" class="product-photo img-fluid" alt="${product13.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product13.name}</a></h5><p class="color-subtext">${product13.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product13.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product13.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
        ...
        listProductsBackground();
        $('#products-show').append(`<div id="${product14.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product14.img1}" class="product-photo img-fluid" alt="${product14.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product14.name}</a></h5><p class="color-subtext">${product14.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product14.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product14.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
        ...
        listProductsBackground();
        $('#products-show').append(`<div id="${product15.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product15.img1}" class="product-photo img-fluid" alt="${product15.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product15.name}</a></h5><p class="color-subtext">${product15.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product15.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product15.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
        ...
        listProductsBackground();
        $('#products-show').append(`<div id="${product16.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product16.img1}" class="product-photo img-fluid" alt="${product16.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product16.name}</a></h5><p class="color-subtext">${product16.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product16.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product16.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
    ...
    if ($('title:first-of-type').text() == 'iCE - Video') {
        $('#products-show').append(`<div id="${product18.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product18.img1}" class="product-photo img-fluid" alt="${product18.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product18.name}</a></h5><p class="color-subtext">${product18.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product18.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product18.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
        ...
        listProductsBackground();
        $('#products-show').append(`<div id="${product20.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product20.img1}" class="product-photo img-fluid" alt="${product20.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product20.name}</a></h5><p class="color-subtext">${product20.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product20.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product20.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
        ...
        listProductsBackground();
        $('#products-show').append(`<div id="${product21.productId}" class="product-lign row py-2 align-items-center"><div class="col-12 col-lg-3"><a href="product.html"><img src="${product21.img1}" class="product-photo img-fluid" alt="${product21.imgAlt}"></a></div><div class="col-12 col-lg-6 align-self-start mt-2"><h5 class="color-text d-inline-block"><a href="product.html">${product21.name}</a></h5><p class="color-subtext">${product21.recap}</p><p class="product-disponibility font-weight-bold"></p></div><div class="d-flex d-lg-block col-12 col-lg-3 text-center justify-content-center"><h3 class="priceTTC col-5 col-lg-12 m-0 p-0 mb-lg-1">${product21.priceTTC}</h3><h4 class="priceHT col-5 col-lg-12 m-0 p-0 mb-lg-3 pt-1 color-subtext">${product21.priceHT}</h4><button class="col-2 col-lg-4 m-0 p-0 btn-productAdd btn btn-primary"><i class="fas fa-cart-plus" aria-hidden="true"></i></button></div></div>`);
