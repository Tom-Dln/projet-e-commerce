...
function indexAttributeProducts() {  
    if ($('title:first-of-type').text() == 'iCE - Accueil') {
        ...
        $(`#card-1 .card-text`).first().text(`${product1.priceTTC}` + '€ TTC');
        ...
        $(`#card-2 .card-text`).first().text(`${product2.priceTTC}` + '€ TTC');
        ...
        $(`#card-3 .card-text`).first().text(`${product3.priceTTC}` + '€ TTC');
        ...
        $(`#card-4 .card-text`).first().text(`${product4.priceTTC}` + '€ TTC');
        ...
        $(`#card-5 .card-text`).first().text(`${product5.priceTTC}` + '€ TTC');
        ...
        $(`#card-6 .card-text`).first().text(`${product6.priceTTC}` + '€ TTC');
